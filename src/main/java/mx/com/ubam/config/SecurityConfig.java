...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers(HttpMethod.POST, "/api/disponibilidad/**").hasAnyRole("admin", "recepcionista")
                ...
                .requestMatchers("/api/citas/listar").hasAnyRole("admin", "recepcionista", "dentista")
                        ...
                        .hasAnyRole("admin", "recepcionista", "dentista")
                        ...
                        //
                        .requestMatchers(HttpMethod.GET, "/api/usuarios/disponibilidad/mia")
                        .hasAnyRole("dentista", "admin", "recepcionista")

                        .requestMatchers(HttpMethod.GET, "/api/citas/contadorsemanas")
                        .hasAnyRole("admin", "recepcionista", "dentista")
